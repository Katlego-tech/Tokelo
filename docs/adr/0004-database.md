...
3. **Aurora PostgreSQL Serverless v2, 0 ACU minimum, one instance** (proposed). It's still
...
Proposed: **Aurora PostgreSQL Serverless v2, engine 16 (16.3 or later), minimum 0 ACU, maximum 2
